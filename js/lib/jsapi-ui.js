...
/***/ function(module, exports, __webpack_require__) {
	...
	window.FSOpen = window.FSOpen || {};
	FSOpen.debug = function (options) {
	    if (instance == null) {
	        instance = new _debugger2.default(options);
	        instance.init();
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Debugger = function () {
	    function Debugger(options) {
	        ...
	        me.roomId = options.roomId || 'fs-jsapi';
	    ...
	    _createClass(Debugger, [{
	        ...
	        value: function init() {
	            var me = this,
	                events = void 0;
	            console.log('Connect to %s, %s', me.host, me.ns);
	        ...
	        value: function onSocketEvent(eventName, event) {
	            ...
	            switch (eventName) {
	                case 'connect':
	                    ...
	                    // 先解绑原有的`join`，再绑定新的事件
	                    me.socket.off('join');
	                    me.socket.on('join', me.onCustomEvent.bind(me, 'join'));
	                    // 向服务端发送`join`指令
	                    me.socket.emit('join', {
	                        roomId: me.roomId
	                    });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _qrcode = __webpack_require__(3);

	var _qrcode2 = _interopRequireDefault(_qrcode);

	var _qrcode3 = __webpack_require__(7);
